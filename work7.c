...
int main()
{
    ...
    int i;
    int sizeofoptab=0,sizeofprog=0,count,j,lenofnum,temp,temp1,temp2,startloc,len,c,m;
     char hexadecimalNumber[100],temparr[2];
            ...
            if(strcmp(obprogp[l].mneu,optab[j].mneu)==0)
            {
              ...
              // puts(s1);
               ...
               for(k=0;k<label;k++)
                ...
                printf("%d\n",length);
                printf("%c\n",obprogp[l].operand[length-1]);
                 //puts(p);
                 if(obprogp[l].operand[length-1]==120||obprogp[l].operand[length-1]==88)
                 {  strcpy(buf,obprogp[l].operand);
                    p=strtok(buf,",");
...
l++;
                            ...
                            //OBJECT PROGRAM
//strcpy(obprogp[1].loc,"2000");
//strcpy(obprogp[l-1].loc,"200A");
//printf("%s\n",obprogp[l-1].loc);
int lengthofprog,l1;
int l2=0;
 int no_of_lines=l-1;
